...
public record ComponentReservedEvent(String username, Integer id) implements GameEvent {

    @Override
    public MessageType eventType() { return MessageType.COMPONENT_RESERVED_EVENT; }
