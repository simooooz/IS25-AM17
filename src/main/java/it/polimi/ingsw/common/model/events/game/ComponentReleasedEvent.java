...
public record ComponentReleasedEvent(String username, Integer id) implements GameEvent {

    @Override
    public MessageType eventType() { return MessageType.COMPONENT_RELEASED_EVENT; }
